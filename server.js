...
function seed() {
  ...
  for (const library of db.libraries.filter(l => l.approved)) {
    ...
    <div class="login-page">
      <div class="login-card">
        ...
        <div class="card" style="box-shadow:none;background:#f8fafc;margin-top:14px">
          <h3>${text(req, "Test Kütüphane Girişleri", "Test Library Logins")}</h3>
          <p><b>Adıyaman Yeşilyurt Halk Kütüphanesi</b><br>yesilyurt@ktb.gov.tr / 123456</p>
          <p><b>Şerik İlçe Halk Kütüphanesi</b><br>serik@ktb.gov.tr / 123456</p>
        </div>
